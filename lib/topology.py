class Topology:
	...
	def refine_topology(self,tree_topology,node_start):
		...
		# Problems with this:
		# 1.) You can only do it once, so if it finds a refinement it will stop
		# 2.) upOne through upThree may not necessarily exist - need to check if they do.  Also add stopping conditions for the recursion.
